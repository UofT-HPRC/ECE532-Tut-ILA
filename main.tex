...
\textbf{Create} a new Vivado project according to the steps in previous tutorial, making sure to add the \textit{tutorial.v} and \textit{tutorial.xdc} files as a source and constraint file respectively. 
...
module tutorial (
	...
	//Output
	assign value_output = {direct_connect,led_shift};
	assign led = value_output;
